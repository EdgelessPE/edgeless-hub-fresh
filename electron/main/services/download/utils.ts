...
function convertPoolMapNode2RendererViewTask(taskId: string, n: PoolMapNode): RendererViewTask {
  return {
    id: taskId,
    ...
    url: n.params.url,
    status: n.status,
    targetPosition: n.returned.targetPosition ?? path.join(n.params.dir, n.params.suggested.fileName),
