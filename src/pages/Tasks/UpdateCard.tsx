...
import {IconCaretDown, IconCaretUp, IconSwap} from "@arco-design/web-react/icon";
...
export const UpdateCard = ({local, online}: Props) => {
  ...
  if (sizeChange > 0) {
    ...
    sizeBadge = <Tag size="small" icon={<IconSwap/>}>0B</Tag>
  }
