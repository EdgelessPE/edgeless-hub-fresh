...
export const TabDownloading = ({next, sharedState}: UpdateTabProps) => {
  ...
  const totalSize = formatSize([taskImage, taskVentoy].reduce((prev, cur) => {
  ...
  return (
    <div className="burn__tab-inner__container">
      ...
      <Space direction="vertical" style={{width: "80%"}}>
        {taskImage.enable && <NaiveProgressBar info={taskImage} colorful="blue"/>}
        {taskVentoy.enable && <NaiveProgressBar info={taskVentoy} colorful="blue"/>}
      </Space>
